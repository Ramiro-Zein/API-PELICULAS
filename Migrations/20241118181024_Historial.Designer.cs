...
namespace API_PELICULAS.Migrations
{
    ...
    [Migration("20241118181024_Historial")]
            ...
            modelBuilder.Entity("API_PELICULAS.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdUsuario = new Guid("56789012-5678-5678-5678-5678901234ef"),
                            ClaveUsuario = "$2a$11$F8DnIFDhpXslT5b3Dcv0BOFF/S.rd5zzM5MzTZVmPRRWnwJmYJRG6",
                            EstatusUsuario = 1,
                        ...
                        {
                            IdUsuario = new Guid("67890123-6789-6789-6789-6789012345f0"),
                            ClaveUsuario = "$2a$11$lY0t38WyOYdrAu5cKS5oCOCNaQOsVdeHIQM4Ibqre1wUvGjxDjDtS",
                            EstatusUsuario = 0,
