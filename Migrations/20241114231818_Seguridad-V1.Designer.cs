...
namespace API_PELICULAS.Migrations
{
    ...
    [Migration("20241114231818_Seguridad-V1")]
    partial class SeguridadV1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("API_PELICULAS.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdUsuario = new Guid("56789012-5678-5678-5678-5678901234ef"),
                            ClaveUsuario = "$2a$11$dJ1i0naIzoq1Ayqotklije4mVOTMEf5pcKRB5OTQQBn2z026Y5ikG",
                            EstatusUsuario = 1,
                        ...
                        {
                            IdUsuario = new Guid("67890123-6789-6789-6789-6789012345f0"),
                            ClaveUsuario = "$2a$11$Hsgy6TKcEHy93rfDvspzk.yOVz2QFOifZ8QNJKFmyox/y48rQHnQi",
                            EstatusUsuario = 0,
